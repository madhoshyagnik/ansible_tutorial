...
```
### So cool thing about ansible is vim (for example) can be installed on 1000+ aws instances in a single command, just put the server public ip-address in inventory file and run the above command.
