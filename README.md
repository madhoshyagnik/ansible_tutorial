...
```
### So cool thing about ansible is vim (for example) can be installed on 1000+ aws instances with a single command, just put the server public ip-address in inventory file and run the above command.
